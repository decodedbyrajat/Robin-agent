...
``https://github.com/IfThenVoid/Robin/tree/main/website/docs/api/model-catalog.json``
"""
...
# Ensure ROBIN_HOME is set for imports that touch it at module level.
os.environ.setdefault("ROBIN_HOME", os.path.join(os.path.expanduser("~"), ".robin"))

from robin_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "robin-agent repo",
            "docs": "https://github.com/IfThenVoid/Robin/tree/main/website/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
