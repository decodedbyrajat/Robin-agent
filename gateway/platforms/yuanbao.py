...
try:
    ...
    _ROBIN_VERSION = "0.0.0"

_APP_VERSION = _ROBIN_VERSION
_BOT_VERSION = _ROBIN_VERSION
_YUANBAO_INSTANCE_ID = str(ROBIN_INSTANCE_ID)  # single source: yuanbao_proto.ROBIN_INSTANCE_ID
