...
Config: ~/.robin/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.robin/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_robin_home()`` helper (ROBIN_HOME-aware and
...
RULES_FILE = get_robin_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_robin_home() / "feishu_comment_pairing.json"
