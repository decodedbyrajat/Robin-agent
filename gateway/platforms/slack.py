...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_robin_home() / "slack_tokens.json"
        ...
        try:
            ...
            # /model work directly without /robin prefix). A single regex
            ...
            # manifest (see `robin slack manifest`). In Socket Mode, Slack
            ...
            from robin_cli.commands import slack_native_slashes
            import re as _re
            ...
            if _slash_names:
                ...
                _slash_pattern = _re.compile(r"^/robin$")

            @self._app.command(_slash_pattern)
            async def handle_robin_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "robin_approve_once",
                "robin_approve_session",
                "robin_approve_always",
                "robin_deny",
            ):
            ...
            for _action_id in (
                "robin_confirm_once",
                "robin_confirm_always",
                "robin_confirm_cancel",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "robin_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "robin_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "robin_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "robin_confirm_once",
                            "value": value,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Approve"},
                            "action_id": "robin_confirm_always",
                            "value": value,
                        },
                        {
                            "type": "button",
                            ...
                            "style": "danger",
                            "action_id": "robin_confirm_cancel",
                            "value": value,
                        },
                    ],
                },
    ...
    async def _handle_slash_confirm_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "robin_confirm_once": "once",
            "robin_confirm_always": "always",
            "robin_confirm_cancel": "cancel",
        }
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "robin_approve_once": "once",
            "robin_approve_session": "session",
            "robin_approve_always": "always",
            "robin_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        The legacy ``/robin <subcommand> [args]`` form is preserved for
        backward compatibility with older workspace manifests and for users
        who want a single entry point for free-form questions (``/robin
        ...
        if slash_name in ("robin", ""):
            # Legacy /robin <subcommand> [args] routing + free-form questions.
            # Empty slash_name falls into this branch for backward compat
            # with any caller that didn't populate command["command"].
            from robin_cli.commands import slack_subcommand_map
