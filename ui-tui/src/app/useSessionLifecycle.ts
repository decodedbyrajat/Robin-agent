...
import type { ScrollBoxHandle } from '@robin/ink'
import { evictInkCaches } from '@robin/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ROBIN_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
