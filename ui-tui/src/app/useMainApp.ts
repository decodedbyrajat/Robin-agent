import { type ScrollBoxHandle, useApp, useHasSelection, useSelection, useStdout, useTerminalTitle } from '@robin/ink'
...
export function useMainApp(gw: GatewayClient) {
  ...
  const cwd = ui.info?.cwd || process.env.ROBIN_CWD || process.cwd()
