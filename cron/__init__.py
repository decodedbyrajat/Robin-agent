"""
Cron job scheduling system for Robin Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    robin gateway install    # Install as a user service
    sudo robin gateway install --system  # Linux servers: boot-time system service
    robin gateway            # Or run in foreground
