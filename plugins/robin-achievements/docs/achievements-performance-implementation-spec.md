...
- persisted runtime files:
  - `~/.robin/plugins/robin-achievements/state.json` (existing unlock state)
  - `~/.robin/plugins/robin-achievements/scan_snapshot.json` (new)
  - `~/.robin/plugins/robin-achievements/scan_checkpoint.json` (new)
