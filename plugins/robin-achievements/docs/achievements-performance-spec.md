...
Owner: robin-achievements plugin
...
### `GET /api/plugins/robin-achievements/achievements`
...
### `POST /api/plugins/robin-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/robin-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/robin-achievements/overview`
...
- Persist plugin data under:
  - `~/.robin/plugins/robin-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.robin/plugins/robin-achievements/scan_checkpoint.json`
...
- `~/.robin/plugins/robin-achievements/`
