...
- Snapshot persisted at `~/.robin/plugins/robin-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.robin/plugins/robin-achievements/scan_checkpoint.json`.
