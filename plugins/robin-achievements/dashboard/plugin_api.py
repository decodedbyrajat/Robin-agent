...
Mounted at /api/plugins/robin-achievements/ by Robin dashboard.
"""
...
def state_path() -> Path:
    return Path.home() / ".robin" / "plugins" / "robin-achievements" / "state.json"


def snapshot_path() -> Path:
    return Path.home() / ".robin" / "plugins" / "robin-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return Path.home() / ".robin" / "plugins" / "robin-achievements" / "scan_checkpoint.json"
...
def analyze_messages(session_id: str, title: str, messages: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        "plugin_events": len(re.findall(r"plugin|dashboard-plugins|__ROBIN_PLUGIN|manifest\.json", full_text, re.I)),
