(function () {
  "use strict";
  // robin-achievements dashboard plugin
  // Originally authored by @PCinkusz — https://github.com/PCinkusz/robin-achievements (MIT).
  // Bundled into robin-agent. Upstream repo remains the staging ground for new
  // badges and UI iteration; the in-progress scan banner below is a small addition
  // layered on top of the original dist bundle.
  const SDK = window.__ROBIN_PLUGIN_SDK__;
  if (!SDK || !window.__ROBIN_PLUGINS__) return;
  ...
  async function api(path, options) {
    const url = "/api/plugins/robin-achievements" + path;
    ...
    return React.createElement("div", { className: "ha-page ha-page-loading" },
      React.createElement("section", { className: "ha-hero ha-loading-hero" },
        React.createElement("div", null,
          ...
          React.createElement("h1", null, "Robin Achievements"),
          React.createElement("p", null, "Scanning Robin session history. First scan can take 5–10 seconds on large histories.")
        ),
      ...
      React.createElement("section", { className: "ha-guide ha-loading-guide" },
        React.createElement("div", null,
          ...
          React.createElement("p", null, "Robin is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.")
        ),
        React.createElement("div", null,
    ...
    return React.createElement("div", { className: "ha-page" },
      React.createElement("section", { className: "ha-hero" },
        React.createElement("div", null,
          React.createElement("div", { className: "ha-kicker" }, "Agentic Gamerscore"),
          React.createElement("h1", null, "Robin Achievements"),
          React.createElement("p", null, "Collectible Robin badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.")
        ),
      ...
      React.createElement("div", { className: "ha-stats" },
        ...
        React.createElement(StatCard, { label: "Latest", value: latest[0] ? latest[0].name : "None yet", hint: latest[0] ? latest[0].category : "run Robin more" })
      ),
      React.createElement("section", { className: "ha-guide" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, "Secrets hide their exact trigger. Once Robin sees a related signal, the card becomes Discovered and shows its requirement.")
        )
      ),
  ...
  window.__ROBIN_PLUGINS__.register("robin-achievements", AchievementsPage);
})();
