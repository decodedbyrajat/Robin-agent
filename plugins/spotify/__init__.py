...
``_check_spotify_available()`` — when the user has not run ``robin auth
spotify``, the tools remain registered (so they appear in ``robin
...
The Spotify auth flow (``robin auth spotify``), CLI plumbing, and docs
