# Streaming LLM Response Support for Robin Agent
...
```
ROBIN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ROBIN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `robin_cli/config.py` | 1 | +streaming config defaults |
