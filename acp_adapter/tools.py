"""ACP tool-call helpers for mapping robin tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map robin tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a robin tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    """Create a ToolCallStart event for the given robin tool invocation."""
