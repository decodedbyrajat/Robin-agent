"""
Skills configuration for Robin Agent.
`robin skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.robin/config.yaml under:
...
from robin_cli.config import cfg_get, load_config, save_config
from robin_cli.colors import Colors, color
from robin_cli.platforms import PLATFORMS as _PLATFORMS
