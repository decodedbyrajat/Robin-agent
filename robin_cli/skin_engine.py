...
Skins are defined as YAML files in ~/.robin/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Robin Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    from robin_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Robin Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.robin/skins/
...
Drop a YAML file in ``~/.robin/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ROBIN_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ROBIN_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Robin — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Robin Agent",
            "welcome": "Welcome to Robin Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
