...
Usage:
    robin pairing list              # Show all pending + approved users
    robin pairing approve <platform> <code>  # Approve a pairing code
    robin pairing revoke <platform> <user_id> # Revoke user access
    robin pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle robin pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: robin pairing {list|approve|revoke|clear-pending}")
        print("Run 'robin pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'robin pairing list' to see pending codes.\n")
