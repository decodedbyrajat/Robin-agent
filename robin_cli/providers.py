"""
Single source of truth for provider identity in Robin Agent.
...
ROBIN_OVERLAYS: Dict[str, RobinOverlay] = {
    ...
    "qwen-oauth": RobinOverlay(
        ...
        base_url_env_var="ROBIN_QWEN_BASE_URL",
    ),
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "robin", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    overlay = ROBIN_OVERLAYS.get(canonical)
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + robin extra
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in ROBIN_OVERLAYS
    if provider == "bedrock":
