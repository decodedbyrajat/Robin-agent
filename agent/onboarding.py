...
def openclaw_residue_hint_cli() -> str:
    ...
    Points users at ``robin claw migrate`` (non-destructive port of config,
    memory, and skills) first. ``robin claw cleanup`` is mentioned as the
    ...
    return (
        ...
        "run `robin claw cleanup` (renames it to ~/.openclaw.pre-migration — "
