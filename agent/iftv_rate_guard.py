...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".robin")
...
def iftv_rate_limit_remaining() -> Optional[float]:
...
def clear_iftv_rate_limit() -> None:
...
def is_genuine_iftv_rate_limit(
    *,
    headers: Optional[Mapping[str, str]] = None,
