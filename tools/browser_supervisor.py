...
DIALOG_BRIDGE_HOST = "robin-dialog-bridge.invalid"
...
(() => {
  if (window.__robinDialogBridgeInstalled) return;
  window.__robinDialogBridgeInstalled = true;
  const ENDPOINT = "http://robin-dialog-bridge.invalid/";
