...
class TestParserRegistry:
    ...
    def test_robin_parser_registered(self):
        parsers = list_parsers()
        assert "robin" in parsers
...
class TestRobinParser:
    @pytest.fixture
    def parser(self):
        return get_parser("robin")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["robin"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use robin format since that's universal
