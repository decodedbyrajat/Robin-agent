...
def test_import_loads_env_from_robin_home(tmp_path, monkeypatch):
    home = tmp_path / ".robin"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-robin-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-robin-home"
