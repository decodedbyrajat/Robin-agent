...
See: https://github.com/IfThenVoid/Robin/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for robin_constants.get_subprocess_home()."""

    def test_returns_none_when_robin_home_unset(self, monkeypatch):
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("ROBIN_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("ROBIN_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_injects_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(robin_home / "home")
    ...
    def test_no_injection_when_robin_home_unset(self, monkeypatch):
        monkeypatch.delenv("ROBIN_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from robin_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from robin_cli.profiles import create_profile
