"""Integration tests for RobinAgentLoop with a local vLLM server.
...
try:
    from environments.agent_loop import AgentResult, RobinAgentLoop
except ImportError:
...
def _make_server_manager():
    ...
    sm = ServerManager([config], tool_parser="robin")
