...
def _reload_constants():
    """Reload robin_constants to get a fresh apply_ipv4_preference."""
    import robin_constants
    importlib.reload(robin_constants)
    return robin_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_robin_ipv4_patched", False) is True
