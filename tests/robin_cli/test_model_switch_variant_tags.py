...
def _run_switch(raw_input: str, current_provider: str = "openrouter") -> str:
    ...
    with patch("robin_cli.model_switch.resolve_alias", return_value=None), \
         patch("robin_cli.model_switch.list_provider_models", return_value=[]), \
         patch("robin_cli.runtime_provider.resolve_runtime_provider",
               return_value={"api_key": "test", "base_url": "", "api_mode": "chat_completions"}), \
         patch("robin_cli.models.validate_requested_model", return_value=_MOCK_VALIDATION), \
