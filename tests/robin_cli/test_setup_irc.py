"""Tests for IRC gateway configuration via `robin setup gateway` UI.
...
class TestIRCFreshInstallDiscovery:
    ...
    def test_irc_status_configured_when_env_set(self, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setenv("IRC_CHANNEL", "#robin")
            monkeypatch.setenv("IRC_NICKNAME", "robin-bot")
...
class TestIRCGatewaySetupFreshInstall:
    """Simulate the full `robin setup gateway` experience with IRC present."""
