...
ROBIN_OVERLAYS keys may be models.dev IDs (e.g. "github-copilot") while
...
def test_copilot_uses_robin_slug():
...
def test_kimi_for_coding_overlay_uses_robin_slug():
...
def test_kilo_overlay_uses_robin_slug():
...
def test_mapped_provider_credential_pool_visibility(monkeypatch):
    ...
    monkeypatch.setattr(
        "robin_cli.auth._load_auth_store",
