"""Tests for the interactive session browser (`robin sessions browse`).
...
from robin_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """robin sessions browse should be parseable."""
        from robin_cli.main import main as _main_entry
