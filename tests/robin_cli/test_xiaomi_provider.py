...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from robin_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ROBIN_OVERLAYS
        overlay = ROBIN_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify robin doctor recognizes Xiaomi env vars."""
