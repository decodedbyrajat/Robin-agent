...
The main() function in robin_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `robin -c model`
...
def _build_parser():
    """Build a minimal replica of the robin top-level parser."""
