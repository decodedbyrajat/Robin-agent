...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @robin_bot", entities=[_mention_entity("hi @robin_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message(
            "/status@robin_bot",
            entities=[_bot_command_entity("/status@robin_bot", "/status@robin_bot")],
        ),
        is_command=True,
    ) is True
