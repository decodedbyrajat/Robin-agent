...
def _isolate(tmp_path, monkeypatch):
    """Redirect ROBIN_HOME and clear module caches."""
...
def _write_config(tmp_path, config_dict):
    """Write a config.yaml to the test ROBIN_HOME."""
    import yaml
...
class TestResolveProviderClientMainAlias:
    ...
    def test_main_resolves_github_copilot_alias(self, tmp_path):
        ...
        with (
            patch("robin_cli.auth.resolve_api_key_provider_credentials", return_value={
...
class TestProvidersDictApiModeAnthropicMessages:
    ...
    def test_providers_dict_propagates_api_mode(self, tmp_path, monkeypatch):
        ...
        from robin_cli.runtime_provider import _get_named_custom_provider
