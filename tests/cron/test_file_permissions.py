...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("robin_cli.config.get_config_path", return_value=config_path), \
             patch("robin_cli.config.ensure_robin_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("robin_cli.config.get_env_path", return_value=env_path), \
             patch("robin_cli.config.ensure_robin_home"):
    ...
    def test_ensure_robin_home_sets_0700(self):
        home = Path(self.tmpdir) / ".robin"
        with patch("robin_cli.config.get_robin_home", return_value=home):
