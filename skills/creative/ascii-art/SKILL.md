...
```bash
python3 -m pyfiglet "ROBIN" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ROBIN&font=Slant" | boxes -d stone
```
