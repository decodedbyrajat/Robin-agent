...
Built for [Robin Agent](https://github.com/IfThenVoid/Robin). Usable in any coding agent. Canonical source lives here; synced to [`IfThenVoid/Robin/skills/creative/ascii-video`](https://github.com/IfThenVoid/Robin/tree/main/skills/creative/ascii-video) via PR.
