...
metadata:
  robin:
    ...
    related_skills: [systematic-debugging, node-inspect-debugger, debugging-robin-tui-commands]
---
...
```bash
source /home/bb/robin-agent/.venv/bin/activate
pip install debugpy
```
...
```json
{
  ...
  "justMyCode": false,
  "pathMappings": [
    { "localRoot": "${workspaceFolder}", "remoteRoot": "/home/bb/robin-agent" }
  ]
}
```
