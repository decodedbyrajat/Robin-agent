...
Control the user's Spotify account via the Robin Spotify toolset (7 tools). Setup guide: https://github.com/IfThenVoid/Robin/tree/main/website/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `robin auth spotify` again.
