...
const STORAGE_KEY = "robin-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `robin_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "robin-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-robin-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-robin-theme-font", "true");
