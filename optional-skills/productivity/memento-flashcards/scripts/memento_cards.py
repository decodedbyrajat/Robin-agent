...
Data file: $ROBIN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ROBIN_HOME = Path(os.environ.get("ROBIN_HOME", Path.home() / ".robin"))
DATA_DIR = _ROBIN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
