...
4. Name the token (e.g., "Robin Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.robin/.env`:
...
```bash
CANVAS="python $ROBIN_HOME/skills/productivity/canvas/scripts/canvas_api.py"
